...
def setup_authentication_zero!
  ...
  gsub_file admin_migration_file,
  ...
  remove_dir "app/views/authentications"
  remove_dir "app/views/identity"
  remove_dir "app/views/passwords"
  remove_dir "app/views/registrations"
  remove_dir "app/views/sessions"

  directory "app/views/authentications"
  directory "app/views/identity"
